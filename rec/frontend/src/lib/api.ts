...
export async function getArpuWeeklyAnalytics(): Promise<ArpuWeeklyAnalytics> {
  return fetchJson(`${BASE}/analytics?type=arpu-weekly`);
}

export async function getArpuWorkflowPlan(): Promise<ArpuWorkflowPlan> {
  return fetchJson(`${BASE}/analytics?type=arpu-workflow`);
}

export async function getSaveCustomerAnalytics(): Promise<SaveCustomerAnalytics> {
  return fetchJson(`${BASE}/analytics?type=save-customer`);
}

export async function getSaveCustomerWorkflowPlan(): Promise<SaveCustomerWorkflowPlan> {
  return fetchJson(`${BASE}/analytics?type=save-customer-workflow`);
}
